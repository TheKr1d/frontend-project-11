// import {inputState} from './state/index.js';
...
// const renderInput = () => {
//     const { state, error, urls } = snapshot(stateInput)
// }
...
// export {renderInput, renderContent, renderModal};
...
//     posts.forEach(({ link, title, description, id }) => {
//         const div = document.createElement('div');
...
//     const { feeds, posts, readPostIds } = contents
//     const domContent = domElements().content;
...
//     domContent.replaceChildren(container);
// }
